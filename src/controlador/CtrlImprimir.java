...
public class CtrlImprimir {
    ...
    public CtrlImprimir() {
        try {
            ...
            this.githubBufferedImage = SamplesCommon.getImage(SamplesCommon.sampleImages.logoJalapena);
    ...
    public void reiniciar(){
        try {
            this.printService = PrinterOutputStream.getPrintServiceByName("LR2000");
            this.printerOutputStream = new PrinterOutputStream(printService);
